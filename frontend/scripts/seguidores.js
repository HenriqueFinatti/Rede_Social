...
async function carregarSeguidoresNome(id_usuario) {
    ...
    const seguidoresArray = Array.isArray(seguidores) ? seguidores : Object.values(seguidores);
...
window.addEventListener("DOMContentLoaded", () => {
     const id_usuario = localStorage.getItem("id"); // pega o id salvo do usuário logado
